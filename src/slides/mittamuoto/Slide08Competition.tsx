  ...
  return (
    <MSSlideLayout variant="default">
      <div className="flex flex-col h-full px-20 py-16">
        <div className="mb-10">
          <T k="comp.section" className="type-caption text-slide-accent tracking-widest uppercase" />
          <T k="comp.title" as="h2" className="type-h1 mt-4 text-slide-gray-900" />
        </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b-2 border-slide-gray-200">
                <th className="type-body font-semibold text-slide-gray-900 text-left py-5 w-[280px]"><T k="comp.header" /></th>
                ...
                <th className="type-body font-semibold text-slide-gray-500 text-center py-5"><T k="comp.traditional" /></th>
              </tr>
            </thead>
            <tbody>
              {rows.map((row) => (
                <tr key={row.key} className="border-b border-slide-gray-100">
                  <td className="type-body text-slide-gray-700 py-4"><T k={`comp.${row.key}`} /></td>
